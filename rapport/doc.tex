...
En effet, on peut avec elle étudier et raisonner sur l'execution d'un programme
tout comme sur la véracité d'une proposition logique.

Ce champs de recherche manque de formalisme, beaucoup de papiers utilisent des
définitions différentes ayant une expressivité équivalente.
Pierre Clairambault a alors proposé une formalisation élégante dans le sens où
elle permet de définir une catégorie cartesienne
...
à montrer que la composition de deux stratégies est bien une stratégie.

Etienne Miquey a proposé un premier jet de fichier Coq et mon travail fu de
...
\item Jeu
\item Jeu tenseur
\item les interactions de stratégies parallèles
\end{itemize}
...
Un jeu résiduel est un jeu, c'est montré en Coq.TODOLINK
\\
...
inductifs $\text{OPlay}_2$ et les $\text{PPlay}_2$.
...
préfixe sur les parties sur un jeu $A\vdash B$.\\
...
Nos stratégies sont maintenant bien définies.TODOCOQLINK
...
\begin{answer}{Définition Coq : Interactions}
...
aux parties $A\vdash B, B\vdash C, A\vdash C$. TODOCOQLINK
...
On définit aussi naturellement la relation de préfixe sur les interactions. TODOCOQLINK
...
\begin{answer}{Stratégie résiduelle}
...
la manière dont ça a été défini sur les parties. TODOLINK

Enfin, il nous a fallu entre autres prouver que l'ensemble des interactions sur les
stratégies parallèles est stable par préfixe. TODOCOQLINK
